...
import ora from "ora";
import { fetchAllPricechartingProducts } from "../../adapters/shopify/services/search-service.js";
import {
  updateVariantPrice,
  setProductCondition,
  setInventoryQuantity,
  deleteProduct,
} from "../../adapters/shopify/services/product-service.js";
import { logLabelSession } from "../components/utils/label-logger.js";
import { formatCurrency } from "../../shared/util/currency.js";
import { gridPrompt } from "../components/prompts/grid-prompt.js";
