...
import {
  ensureExpansionIconFile,
  findFileByFilename,
  searchFilesByTerm,
} from "../adapters/shopify/services/file-service.js";
import saveProduct from "../adapters/shopify/services/draft-service.js";
import { appendCsvRows } from "../shared/csv/csv-writer.js";
import { convertToUSD } from "../shared/util/currency.js";
 ...
 *  4. Persist to Shopify via `saveProduct` and append the CSV entry.
 *
